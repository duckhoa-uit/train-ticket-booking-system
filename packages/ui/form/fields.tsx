...
export function Label(props: JSX.IntrinsicElements['label']) {
  return (
    <label {...props} className={cn('text-default block text-sm font-medium', props.className)}>
      {props.children}
    </label>
  );
}
      ...
      {addOnLeading ? (
        <div className="mt-1 flex rounded-md shadow-sm">
          ...
          <Input
            ...
            className={cn('mt-0', props.addOnLeading && 'rounded-l-none', className)}
            {...passThrough}
            ref={ref}
          />
        </div>
...
export function FieldsetLegend(props: JSX.IntrinsicElements['legend']) {
  return (
    <legend {...props} className={cn('text-default text-sm font-medium', props.className)}>
      {props.children}
    </legend>
  );
}
