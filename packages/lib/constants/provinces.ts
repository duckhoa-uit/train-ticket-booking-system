...
type Provinces = typeof provinces;
// const provincesMappedObj = provinces.reduce((prev, curr) => {
//   prev[curr.codename] = curr
//   return prev
// }, {} as Record<Provinces[number]['codename'], Province<Provinces[number]['codename']>>)

// un_stable
export type Province<CodeName = Provinces[number]["codename"]> = {
  name: Provinces[number]["name"];
  codename: CodeName; //cai nay se luu o db
};

// un_stable
// export type District<T = Provinces[number]['codename']> = {
//   provinceCodename: T
