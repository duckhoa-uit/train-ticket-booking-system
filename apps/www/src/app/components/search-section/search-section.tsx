...
export const SearchSection = () => {
  return (
    <div className="relative min-h-[calc(100dvh-64px)] bg-[url('/img/railway-banner.webp')] bg-cover bg-center bg-no-repeat md:min-h-[calc(100dvh-80px)] lg:px-0 lg:py-20">
      ...
      <div className="z-50 flex h-auto w-full translate-y-1/2 transform flex-col items-center justify-center gap-3 md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2">
        <div className="px-8">
