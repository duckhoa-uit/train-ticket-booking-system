...
import { TrainsTableFloatingBar } from "./trains-table-floating-bar";
...
export function TrainsTable({ data, pageCount }: TrainsTableProps) {
  ...
  const columns = React.useMemo<ColumnDef<Train, unknown>[]>(
    () => [
      {
        id: "select",
        header: ({ table }) => (
